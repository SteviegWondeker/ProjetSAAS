...
class Vue():
    ...
    def creercadreprincipal(self, usager):
        ...
        self.btn_new_contact = Button(self.contacts_details_frame, text="Ajouter une tache", command= self.ajouter_tache)
    ...
    def creer_cadre_nouveau_contact(self):
        ...
        self.contact_lab_prenom = Label(self.cadre_inscrire_tache, text="Prénom:", font=("Arial", 14))
        self.contact_prenom = Entry(self.cadre_inscrire_tache, font=("Arial", 14), width=30)
        self.contact_lab_nom = Label(self.cadre_inscrire_tache, text="Nom:", font=("Arial", 14))
        self.contact_nom = Entry(self.cadre_inscrire_tache, font=("Arial", 14), width=30)
        self.contact_lab_tags = Label(self.cadre_inscrire_tache, text="Expertise:", font=("Arial", 14))
        self.contact_ajout_tag = Entry(self.cadre_inscrire_tache, font=("Arial", 14), width=20)
...
#        self.membre_role = Entry(self.cadre_inscrire_tache, font=("Arial", 14), width=30)
        ...
        self.contact_tags = ttk.OptionMenu(self.cadre_inscrire_tache, self.value_inside, "Choisir une option", *self.list_tags, command=self.selection_tag)
        #ttk.Combobox(self.cadre_inscrire_tache, values=self.list_tags)

        self.contact_lab_courriel = Label(self.cadre_inscrire_tache, text="Courriel:", font=("Arial", 14))
        self.contact_courriel = Entry(self.cadre_inscrire_tache, font=("Arial", 14), width=30)
       
        self.contact_lab_details = Label(self.cadre_inscrire_tache, text="Détails:", font=("Arial", 14))
        self.contact_details = Text(self.cadre_inscrire_tache, font=("Arial", 14), width=30, height=5)
        self.contact_lab_note = Label(self.cadre_inscrire_tache, text="Notes importantes:", font=("Arial", 14))
        self.contact_note = Text(self.cadre_inscrire_tache, font=("Arial", 14), width=30, height=2)
        ...
        self.btn_inscrire_contact = Button(self.cadre_inscrire_tache, text="Inscrire le nouveau contact", font=("Arial", 12), padx=10, pady=10,
