...
#######################################################################################################################################
#######################################################################################################################################
    def trouver_transactions_par_compagnie(self, comp, module):        # Alex
        print(comp)
        sqlnom = ("""SELECT modules.nommodule, (SELECT COUNT(*) FROM transactions WHERE lecture = 1 AND modules.idmodule = :module), (SELECT COUNT(*) FROM transactions WHERE lecture = 0 AND modules.idmodule = :module) 
	                FROM transactions
	                ...
	                WHERE compagnie.nomcompagnie = :comp AND modules.idmodule = :module
...
def trouver_transactions_par_compagnie():
    if request.method=="POST":
        ...
        print(comp)
        transaction = db.trouver_transactions_par_compagnie(comp, module)
