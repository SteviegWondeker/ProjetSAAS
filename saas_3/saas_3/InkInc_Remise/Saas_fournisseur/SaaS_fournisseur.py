...
class Vue():
    ...
    def creercadreuser(self):          # Alex
        ...
        self.usagercourant = Label(self.cadretitre, text="ADMIN",
                                   font=("Arial", 14))
        self.titreuser.pack()
    ...
    def trouver_transactions_par_compagnie(self, comp):
        print("LISTE PROJEEEEEEEET!!!!!")
        listeprojets = self.parent.trouver_transactions_par_compagnie(comp, 1)
        print(listeprojets)
        entete = ["Module", "Nb Accès Lecture", "Nb Accès Écriture"]
...
class Controleur:
    ...
    def trouver_transactions_par_compagnie(self, comp, module):
